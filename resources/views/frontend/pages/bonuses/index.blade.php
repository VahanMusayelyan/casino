...
<link rel="stylesheet" type="text/css" href="/css/mobile_design.css">
@endpush
@section('content')

<div class="content" style="align-items: unset;">
	<h1 class="bonuses_heading">{{__("Bonuses")}}</h1>
	<div class="container_bonuses_block">
		<div class="left_bonus_block">
			<h3 class="referral_program">{{__("Referral program")}}</h3>
			<p class="referral_frineds">{{__("Refer your friends to our casino and get bonus credits.")}}
				{{__("Please copy the link below and share with your friends.")}}</p>
			<div style="display: flex; justify-content: center; align-items: center;">
				<input type="text" value="{{request()->getHost()}}?ref={{auth()->user()->id}}" class="input_site_link" id="myInput" readonly>
				<a onclick="myFunction()"><img src="{{asset("assets/img/bonuses/Group 11 Copy.png")}}" alt=""
													   class="copy_button"></a>
			</div>
			<div class="social_block">
				<a href="mailto:?subject={{ $share_subject }}&body={{ $share_body }}"><img src="{{asset("assets/img/bonuses/Mail.png")}}" alt=""></a>
				<a href="https://www.facebook.com/sharer.php?u={{ $referral_url }}"><img src="assets/img/bonuses/Facebook.png" alt=""></a>
				<a href="https://twitter.com/intent/tweet?url={{ $referral_url }}&text={{ $share_subject }}" alt=""><img src="assets/img/bonuses/Twitter.png"></a>
				<a href="whatsapp://send?text={{ $share_subject . ':' . $referral_url }}"><img src="assets/img/bonuses/whatsapp.png" alt=""></a>
			</div>
			<h4 class="bonuses_for_users">{{__("You will get the following bonuses for referred users")}}</h4>
			<div style="display: flex; justify-content: center;  align-items: center;">
				<div class="left_img">
			...
			<div class="last_paragraph" style="color: #ffffff; font-size: 16px; opacity: 0.5;">
				{{__("You referred")}} {{$referred_users_count}} {{__("users and earned")}}
				{{$referral_total_bonus}} {{__("credits so far")}}
			</div>
		</div>
