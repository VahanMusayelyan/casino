...
@section('content')
    ...
    <div id="content" class="bg-secondary">
        <div class="row">
            <div class="col"><h1 class="mb-3">
                    Privacy policy
                </h1></div>
        </div>
        <div class="row">
            <div class="col"><p>
                    This privacy notice discloses the privacy practices for <a
                            href="https://cryptocasino.financialplugins.com">https://cryptocasino.financialplugins.com</a>.
                    This privacy notice applies solely to information collected by this website. It will notify you of
                    the following:
                </p>
                <ul>
                    <li>What personally identifiable information is collected from you through the website, how it is
