...
return [
    ...
    */
    ...
    'facebook' => [
        ...
        'redirect'      => env('FACEBOOK_REDIRECT'), // If the redirect option contains a relative path, it will automatically be resolved to a fully qualified URL.
    ],
    ...
    'yahoo' => [
        ...
        'redirect'      => env('YAHOO_REDIRECT'), // If the redirect option contains a relative path, it will automatically be resolved to a fully qualified URL.
    ],
