...
Route::name('frontend.')
    ...
    ->group(function () {
        ...
        Route::post('/jackpot', 'PageController@jackpot')->name('jackpot');
    });
...
Route::get('page/provably-fair', '\App\Http\Controllers\Frontend\PageController@provably_fair')->name('provably.index');
Route::get('page/privacy-policy', '\App\Http\Controllers\Frontend\PageController@policy')->name('policy');
Route::get('page/privacy-policy', '\App\Http\Controllers\Frontend\PageController@policy')->name('policy');
Route::get('terms-of-service', '\App\Http\Controllers\Frontend\PageController@terms_use')->name('terms_use');
Route::get('page/affiliate', '\App\Http\Controllers\Frontend\PageController@affiliate')->name('affilate');

Route::get('raffle', '\Packages\Raffle\Http\Controllers\Frontend\RaffleController@index')->name('frontend.raffle.index');
Route::get('raffle/history', '\Packages\Raffle\Http\Controllers\Frontend\RaffleController@history')->name('frontend.raffle.history');
Route::post('raffles/{raffle}/ticket', '\Packages\Raffle\Http\Controllers\Frontend\RaffleController@ticket')->name('frontend.raffle.ticket');
...
Route::get('auth/yahoo', 'Auth\YahooController@redirectToYahoo');
Route::get('auth/yahoo/callback', 'Auth\YahooController@handleYahooCallback');
